...
const styles: Record<Variant, string> = {
  primary:
    "bg-gradient-to-b from-accent to-accent-deep text-white shadow-[0_4px_16px_rgba(28,110,247,0.35),inset_0_1px_0_rgba(255,255,255,0.25)] hover:brightness-110",
  ghost:
